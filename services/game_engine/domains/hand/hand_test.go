...
func (as *HandSuite) SetupTest() {}

func (as *HandSuite) TearDownTest() {
...
func TestHandSuite(t *goTesting.T) {
	hs := &HandSuite{
...
func (hs *HandSuite) setupEnvironment() {
...
func (gs *HandSuite) prepareCards() ([]*dataProviderProto.Card, map[string]*dataProviderProto.Card, map[string]*dataProviderProto.Card) {
